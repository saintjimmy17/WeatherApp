...
export class AppComponent {
  ...
  constructor(private weather:WeatherService){ //al iniciar el aplicativo pide la ubicacion y muestra el clima de lugar actual
    ...
    setTimeout(()=>{
      //esperamos 1 segundo y medio para verificar si el usuario si permitio la ubicacion sino se obtendrá el clima por defecto de cordoba
      if(this.weatherInfo.length === 0){
        this.getWeatherInfo("cordoba");
      }
